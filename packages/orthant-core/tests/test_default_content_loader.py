...
class TestDefaultContentLoader:
    ...
    def test_protocol_conformance(self, loader):
        """Test that DefaultContentLoader conforms to ContentLoader protocol"""
        from orthant.core.documents.content_loader import ContentLoader
